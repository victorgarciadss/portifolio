    ...
    return(
        <div id='about-me'>
            ...
            <section className="about">
                ...
                <p className='paragraph-aboutMe'>
                    &nbsp; Para desenvolvimento FrontEnd, costumo utilizar bibliotecas como React e dependendo do caso, utilizo o framework NextJs em conjunto. Trabalho com grande foco em garantir uma boa excelente experiência para o usuário e também busco garantir uma boa performance tanto do lado do cliente quanto do servidor.
                </p>

                <p className='paragraph-aboutMe'>
                    &nbsp; Atualmente curso Análise e Desenvolvimento de Sistemas com previsão de finalizar no final de 2025 onde adquiri conhecimentos em conceitos como estruturas de dados, algoritmos, programção orientada a objetos, engenharia de software, dentre outros.
                </p>
